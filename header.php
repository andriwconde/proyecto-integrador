      ...
      <form class="form-inline my-2 my-lg-0">
        ...
        <form class="form-inline my-2 my-lg-0">
          <a href="#" class=" mr-2 " data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" >
            <button type="button" class="btn rounded-circle btn-outline-dark boton-session" >
            <img src="<?= $_SESSION["usuario"]["avatar"] ?>" class="rounded-circle rounded-sm img-fluid" alt="">
            </button>
         </a>
         <a href="carrito.php">
           <button type="button" class="btn rounded-circle btn-outline-dark boton-session">
